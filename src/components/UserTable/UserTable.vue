    ...
    <div class="table-header">
      <div class="header-left">
        ...
        <span class="total-count"
          >{{ filteredAndSearchedUsers.length }} записей</span
        >
      </div>
    ...
    >
      <div class="modal">
        ...
        <div class="modal-footer">
          <button @click="closeAddUserModal" class="btn btn-secondary">
            Отмена
          </button>
          <button
            @click="addNewUser"
        ...
        <div class="modal-body" v-if="selectedUser">
          <div class="user-details">
            <div class="detail-section">
              <img
                :src="
                  selectedUser.avatar || getDefaultAvatar(selectedUser.name)
                "
...
export default {
  ...
  computed: {
    ...
    statusFilteredUsers() {
      ...
      return this.roleFilteredUsers.filter(
        (user) => user.status === this.filterStatus
      );
    },
    ...
    sortedUsers() {
      ...
      users.sort((a, b) => {
        ...
        if (
          this.sortColumn === "registrationDate" ||
          this.sortColumn === "lastActivity"
        ) {
  ...
  methods: {
    ...
    async deleteSelectedUsers() {
      if (
        !confirm(
          `Вы уверены, что хотите удалить ${this.selectedUsers.length} пользователей?`
        )
      ) {
        return;
      }
